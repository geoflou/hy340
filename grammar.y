...
expr: assignexpr    {printf("assignexpr -> expr\n");
    ...
    | expr OPERATOR_GRT expr    {   printf("expr > expr -> expr\n");
                                    ...
                                    numquads++;
                                    //to false
                                    emit(assign, tmp, NULL, newExpr_constbool(0), (int)NULL, yylineno);
                                    ...
                                    numquads++;
                                    //to true
                                    emit(assign, tmp, NULL, newExpr_constbool(1), (int)NULL, yylineno);
...
ifstmt: IF LEFT_PARENTHESIS expr RIGHT_PARENTHESIS stmt   {printf("if(expr) -> ifstmt\n");
                                    ...
                                    ifexpr -> boolConst = 1;
                                    emit(if_eq,ifexpr-> boolConst,NULL,$<exp>3,label+2, yylineno);
